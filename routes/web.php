...
// ✅ API lấy giờ làm việc bác sĩ (dành cho đặt lịch, không cần đăng nhập)
Route::get('/get-working-hours', [AdminController::class, 'getWorkingHours'])->name('getWorkingHours');
